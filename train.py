...
class Trainer:
    ...
    def __init__(self, path, model, model_copy, img_save_path):
        ...
        self.loader = DataLoader(dataset.Datasets(path), batch_size=4, shuffle=True, num_workers=2)
...
if __name__ == '__main__':
    # 路径改一下
    t = Trainer(r"DRIVE\training2", r'./model.plt', r'./model_{}_{}.plt', img_save_path=r'./train_img')
    t.train(150)
